    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-3ao3fc");
    			add_location(input0, file$5, 19, 12, 390);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-3ao3fc");
    			add_location(label0, file$5, 27, 12, 621);
    			attr_dev(li0, "class", "svelte-3ao3fc");
    			add_location(li0, file$5, 18, 8, 372);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-3ao3fc");
    			add_location(input1, file$5, 30, 12, 691);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-3ao3fc");
    			add_location(label1, file$5, 38, 12, 922);
    			attr_dev(li1, "class", "svelte-3ao3fc");
    			add_location(li1, file$5, 29, 8, 673);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-3ao3fc");
    			add_location(input2, file$5, 41, 12, 992);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-3ao3fc");
    			add_location(label2, file$5, 49, 12, 1223);
    			attr_dev(li2, "class", "svelte-3ao3fc");
    			add_location(li2, file$5, 40, 8, 974);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-3ao3fc");
    			add_location(input3, file$5, 52, 12, 1293);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-3ao3fc");
    			add_location(label3, file$5, 60, 12, 1524);
    			attr_dev(li3, "class", "svelte-3ao3fc");
    			add_location(li3, file$5, 51, 8, 1275);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-3ao3fc");
    			add_location(input4, file$5, 63, 12, 1594);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-3ao3fc");
    			add_location(label4, file$5, 71, 12, 1825);
    			attr_dev(li4, "class", "svelte-3ao3fc");
    			add_location(li4, file$5, 62, 8, 1576);
    			attr_dev(div0, "class", "rating-row svelte-3ao3fc");
    			add_location(div0, file$5, 17, 4, 338);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-3ao3fc");
    			add_location(input5, file$5, 76, 12, 1937);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-3ao3fc");
    			add_location(label5, file$5, 84, 12, 2168);
    			attr_dev(li5, "class", "svelte-3ao3fc");
    			add_location(li5, file$5, 75, 8, 1919);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-3ao3fc");
    			add_location(input6, file$5, 87, 12, 2238);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-3ao3fc");
    			add_location(label6, file$5, 95, 12, 2469);
    			attr_dev(li6, "class", "svelte-3ao3fc");
    			add_location(li6, file$5, 86, 8, 2220);
    			...
    			attr_dev(input7, "class", "svelte-3ao3fc");
    			add_location(input7, file$5, 98, 12, 2539);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-3ao3fc");
    			add_location(label7, file$5, 106, 12, 2770);
    			attr_dev(li7, "class", "svelte-3ao3fc");
    			add_location(li7, file$5, 97, 8, 2521);
    			...
    			attr_dev(input8, "class", "svelte-3ao3fc");
    			add_location(input8, file$5, 109, 12, 2840);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-3ao3fc");
    			add_location(label8, file$5, 117, 12, 3071);
    			attr_dev(li8, "class", "svelte-3ao3fc");
    			add_location(li8, file$5, 108, 8, 2822);
    			...
    			attr_dev(input9, "class", "svelte-3ao3fc");
    			add_location(input9, file$5, 120, 12, 3141);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-3ao3fc");
    			add_location(label9, file$5, 128, 12, 3375);
    			attr_dev(li9, "class", "svelte-3ao3fc");
    			add_location(li9, file$5, 119, 8, 3123);
    			attr_dev(div1, "class", "rating-row svelte-3ao3fc");
    			add_location(div1, file$5, 74, 4, 1885);
    			attr_dev(ul, "class", "rating svelte-3ao3fc");
    			add_location(ul, file$5, 16, 0, 313);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-1xpchr0");
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 32, 2, 817);
    			attr_dev(button, "class", "close svelte-r0i3k0");
    			add_location(button, file$3, 35, 2, 875);
    			attr_dev(p0, "class", "text-display");
    			add_location(p0, file$3, 36, 2, 950);
    			add_location(p1, file$3, 39, 2, 1003);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
