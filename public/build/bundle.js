    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$5, 18, 8, 352);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-kw4tmt");
    			add_location(label0, file$5, 26, 8, 551);
    			attr_dev(li0, "class", "svelte-kw4tmt");
    			add_location(li0, file$5, 17, 4, 338);
    			...
    			add_location(input1, file$5, 29, 8, 609);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-kw4tmt");
    			add_location(label1, file$5, 37, 8, 808);
    			attr_dev(li1, "class", "svelte-kw4tmt");
    			add_location(li1, file$5, 28, 4, 595);
    			...
    			add_location(input2, file$5, 40, 8, 866);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-kw4tmt");
    			add_location(label2, file$5, 48, 8, 1065);
    			attr_dev(li2, "class", "svelte-kw4tmt");
    			add_location(li2, file$5, 39, 4, 852);
    			...
    			add_location(input3, file$5, 51, 8, 1123);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-kw4tmt");
    			add_location(label3, file$5, 59, 8, 1322);
    			attr_dev(li3, "class", "svelte-kw4tmt");
    			add_location(li3, file$5, 50, 4, 1109);
    			...
    			add_location(input4, file$5, 62, 8, 1380);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-kw4tmt");
    			add_location(label4, file$5, 70, 8, 1579);
    			attr_dev(li4, "class", "svelte-kw4tmt");
    			add_location(li4, file$5, 61, 4, 1366);
    			...
    			add_location(input5, file$5, 73, 8, 1637);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-kw4tmt");
    			add_location(label5, file$5, 81, 8, 1836);
    			attr_dev(li5, "class", "svelte-kw4tmt");
    			add_location(li5, file$5, 72, 4, 1623);
    			...
    			add_location(input6, file$5, 84, 8, 1894);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-kw4tmt");
    			add_location(label6, file$5, 92, 8, 2093);
    			attr_dev(li6, "class", "svelte-kw4tmt");
    			add_location(li6, file$5, 83, 4, 1880);
    			...
    			add_location(input7, file$5, 95, 8, 2151);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-kw4tmt");
    			add_location(label7, file$5, 103, 8, 2350);
    			attr_dev(li7, "class", "svelte-kw4tmt");
    			add_location(li7, file$5, 94, 4, 2137);
    			...
    			add_location(input8, file$5, 106, 8, 2408);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-kw4tmt");
    			add_location(label8, file$5, 114, 8, 2607);
    			attr_dev(li8, "class", "svelte-kw4tmt");
    			add_location(li8, file$5, 105, 4, 2394);
    			...
    			add_location(input9, file$5, 117, 8, 2665);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-kw4tmt");
    			add_location(label9, file$5, 125, 8, 2867);
    			attr_dev(li9, "class", "svelte-kw4tmt");
    			add_location(li9, file$5, 116, 4, 2651);
